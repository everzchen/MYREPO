...
y-hat is equal to the average of y, "given" our grouping variable to x - so, given that our college education is in the first quartile.
$$\hat{Y}=(\bar{Y}|X=x) $$
...
We can quantify this using MSE
